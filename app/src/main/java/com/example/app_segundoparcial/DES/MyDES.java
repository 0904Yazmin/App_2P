package com.example.app_segundoparcial.DES;
...
public class MyDES implements Serializable {
    ...
    public MyDES(String stringKeyBase64)
    {
        this.stringKeyBase64 = stringKeyBase64;
    }

    public MyDES addStringKeyBase64( String stringKeyBase64 )
    {
        this.stringKeyBase64 = stringKeyBase64;
        return this;
    }
